...
#                 elif request.user.userdetails.fk_desig.vchr_name.upper() in ['MANAGER - BUSINESS OPERATIONS']:
#                     dct_filter['blnDept'] = True
#                     dct_filter['blnEmployee'] = True
#                     dct_filter['blnBrand'] = True
#                     dct_filter['blnPhysicalLoc'] = True
...
#                 elif request.user.userdetails.fk_desig.vchr_name.upper() in ['GM SPECIAL PROJECTS']:
#                     dct_filter['blnDept'] = True
#                     dct_filter['blnEmployee'] = True
#                     dct_filter['blnBrand'] = True
#                     dct_filter['blnPhysicalLoc'] = True
...
#                 elif request.user.userdetails.fk_desig.vchr_name.upper() in ['BUISNESS HEAD','BUSINESS HEAD']:
#                     dct_filter['blnDept'] = True
#                     dct_filter['blnEmployee'] = True
#                     dct_filter['blnBrand'] = True
#                     dct_filter['blnPhysicalLoc'] = True
