...
#    while not  stock_transfer_api2:
 #       stock_transfer_api2 = stock_transfer_api('-1',doc_date1)
    ...
    #while not  purchase_invoice_api2:
     #   purchase_invoice_api2 = purchase_invoice_api('-1',doc_date1)
    #while not  purchase_invoice_api1:
     #   purchase_invoice_api1 = purchase_invoice_api("0,1",doc_date)
    print("\n-----------------------------------------------------------ang_stock_transfer_with_bill_api-----------------------------------------------\n")
    #while not  bill_api_call2:
     #   bill_api_call2 = bill_api_call("-1",doc_date1)
    #while not  bill_api_call1:
     #   bill_api_call1 = bill_api_call("0,1",doc_date)
    print("\n-----------------------------------------------------------ang_stock_transfer_with_creditmemo_api-----------------------------------------------\n")
   # while not  return_api_call2:
    #    return_api_call2 = return_api_call("-1",doc_date1)
   # while not  return_api_call1:
    #    return_api_call1 = return_api_call("0,1",doc_date)
    print("\n-----------------------------------------------------------ang_stock_transfer_with_salesreturn_api-----------------------------------------------\n")
   # while not  purchase_return_api2:
    #    purchase_return_api2 = purchase_return_api("-1",doc_date1)
    #while not  purchase_return_api1:
     #   purchase_return_api1 = purchase_return_api("0,1",doc_date)
    print("\n-----------------------------------------------------------advance to sap-----------------------------------------------\n")
    #while not  advance_to_sap2:
     #   advance_to_sap2 = advance_to_sap("-1",doc_date1)
    #while not  advance_to_sap1:
     #   advance_to_sap1 = advance_to_sap("0,1",doc_date)
    #print("\n-----------------------------------------------------------advance refund-----------------------------------------------\n")
    #while not  AdvanceRefundMethod2:
     #   AdvanceRefundMethod2 = AdvanceRefundMethod("-1",doc_date1)
    #while not  AdvanceRefundMethod1:
     #   AdvanceRefundMethod1 = AdvanceRefundMethod("0,1",doc_date)
    print("\n-----------------------------------------------------------bills to sap-----------------------------------------------\n")
    #while not  bills_to_sap2:
     #   bills_to_sap2 = bills_to_sap("-1",doc_date1)
    while not  bills_to_sap1:
        bills_to_sap1 = bills_to_sap("0,1,-2,-1",doc_date)
    print("\n-----------------------------------------------------------discount journal-----------------------------------------------\n")
    #while not  discountJournal2:
     #   discountJournal2 = discountJournal("-1",doc_date1)
    while not  discountJournal1:
        discountJournal1 = discountJournal("0,1,-2,-1",doc_date)
    print("\n-----------------------------------------------------------sales return-----------------------------------------------\n")
   # while not  sales_return_to_sale2:
   #     sales_return_to_sale2 = sales_return_to_sale("-1",doc_date1)
...
while True:
    ...
    lst_date = ['2020-06-01','2020-06-02','2020-06-03','2020-06-04','2020-06-05','2020-06-06','2020-06-08','2020-06-09','2020-06-10','2020-06-11','2020-06-12','2020-06-13', '2020-06-14', '2020-06-15', '2020-06-16', '2020-06-17', '2020-06-18', '2020-06-19', '2020-06-20', '2020-06-21', '2020-06-22', '2020-06-23', '2020-06-24','2020-06-25','2020-06-26','2020-06-27']
   # lst_date = ['2020-06-19','2020-06-20','2020-06-22','2020-06-24']
#    lst_date = ['2020-06-24']
