...
from staff_rewards2.views import RewardPaidSave,AddReward,GetRewardDetails,AreaSearch,RewardsList,StaffRewardList,StaffRewardList,StaffByBranch,RewardPaidList,RewardPaidListDownload
