    ...
    def put(self,request):
        ...
        try:
            ...
            if int_branch_id:
                ...
                #listig all staff id's and it reward amount
                rst_staff_list =session.query(RewardsAvailableJS.c.json_staff.label('staff_id')).filter(and_(RewardsAvailableJS.c.dat_reward >= dat_from,RewardsAvailableJS.c.dat_reward <= dat_to))
