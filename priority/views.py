    ...
    def get(self, request,):
        try:
            ...
            if id > 0:
                ...
                lst_priority = list(Priority.objects.filter(bln_status=True,fk_company = ins_company).values('vchr_priority_name','pk_bint_id').order_by('pk_bint_id'))
    ...
    def post(self, request,):
        try:
            ...
            if in_count>=7:
                ...
                ins_priority = Priority(vchr_priority_name = str_name,bln_status=True,fk_company_id = int_company_id)
                ins_priority.save()
